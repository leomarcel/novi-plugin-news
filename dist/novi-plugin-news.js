...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Icons = novi.ui.icons;
	var Icon = novi.ui.icon;
	var messages = novi.language.getDataByKey("novi-plugin-owl-news");
	var AddSlideItem = {
	    trigger: React.createElement(
	        Icon,
	        null,
	...
	function insertChildElement(element, childElement, staticSlide) {
	    ...
	    if (insertIndex) {
	        ...
	        news.trigger('to.owl.news', [_insertIndex, 200, true]);
	    }
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function removeElement(element, staticSlide, childElement) {
	    ...
	    news.trigger('remove.owl.news', removeIndex);
	    news.trigger('refresh.owl.news');
	}
